...
<template>
  ...
  <AdminHeader />
  <AdminForm v-model:showEditForm="showEditForm" v-model:selectedReservation="selectedReservation" v-model:showError="showError" v-model:showSuccess="showSuccess" />

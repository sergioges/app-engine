  ...
  <v-form ref="form" class="mb-4">
    <v-row>
      <v-col class="d-flex flex-column ga-4 mb-2" cols="12" md="12">
        ...
        <v-text-field v-model="contactData.phone" required :rules="phoneValidation" label="Móvil"
          prepend-icon="mdi-cellphone" hide-details="auto" variant="solo" type="tel">
        </v-text-field>
    ...
    <v-row v-if="!isTestPaymentAvailable && isPaymentAvailable && props.totalNights <= 5" align="center" justify="center">
      <v-col cols="12" md="6">
